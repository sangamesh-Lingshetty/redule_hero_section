...
export const pipelineStages: readonly PipelineStage[] = [
  ...
  },
  {
    ...
    description: 'Webhooks, schedules and inbound signals',
  ...
  },
  {
    ...
    description: 'Immutable events created from triggers',
  ...
  },
  {
    ...
    description: 'Authorized actions being executed',
  ...
  },
  {
    ...
    description: 'Verified confirmed results',
